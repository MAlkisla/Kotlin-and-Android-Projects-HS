...
fun main() {
    while (true) {
        ...
        val habitatNumber = input?.toIntOrNull()
        if (habitatNumber != null && habitatNumber in 0 until animals.size) {
            println(animals[habitatNumber])
        } else {
            println("Invalid input. Please enter a valid habitat number or 'exit' to quit.")
        }
    }
