...
fun main() {
    val find = File("/C:/Users/Meric/IdeaProjects/Phone Book (Kotlin)/Phone Book (Kotlin)/find3.txt").readLines()
    var directory = File("/C:/Users/Meric/IdeaProjects/Phone Book (Kotlin)/Phone Book (Kotlin)/directory3.txt").readLines()
